...
*Where I Belong* é um jogo narrativo desenvolvido durante a **Global Game Jam 2019**, com foco em **narrativa ambiental, memória e pertencimento**.
...
Este projeto faz parte do meu **portfólio profissional** e demonstra minha atuação prática em **Game Design, Programação e Level Design**, desde a concepção até a implementação final.
...
* Concepção da experiência narrativa e temática
* Definição do fluxo do jogador e do ritmo da experiência
...
* Integração entre gameplay, narrativa e feedback ao jogador
* Suporte técnico geral durante o desenvolvimento em **Unity**
...
1. Faça o download do build disponível na pasta `build/`
2. Descompacte o arquivo
3. Abra a pasta extraída
4. Execute o arquivo **Where I Belong**
...
* **Página Oficial:**
  [https://v3.globalgamejam.org/2019/games/where-i-belong-0](https://v3.globalgamejam.org/2019/games/where-i-belong-0)
